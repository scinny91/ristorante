...
$('body').append('' +
    //'<div class="fixed-button">' + '<a href="https://appseed.us/admin-dashboards/flask-dashboard-dattaable" target="_blank" class="btn btn-md btn-primary">' + '<i class="fa fa-shopping-cart" aria-hidden="true"></i> See Product' +
    '</a> ' + '</div>' + '');
var $window = $(window);
